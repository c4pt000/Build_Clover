...
RSCRIPT_INFO="sync edk2 svn r29388 (tagged as edk2-stable201903)"
RSCRIPTVER=""
export LC_ALL=C
SYSNAME="$( uname )"
...
REMOTE_EDK2_REV="29388" # info for developer submenu this mean to show latest rev avaiable


#	OptionRomPkg   	   part	of edk2array cant pull 05-18-2019? >r29388
